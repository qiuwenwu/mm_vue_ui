...
import mm_tip from "../components/mm/base/mm_tip.vue"
import control_time from "../components/mm/control/control_time.vue"
...
import control_upload_img from "../components/mm/control/control_upload_img.vue"
...
export default {
	install(Vue, options) {
		...
		Vue.component("control_time", control_time);
		...
		Vue.component("control_upload_img", control_upload_img);
